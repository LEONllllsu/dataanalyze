    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(blank=True, max_length=20, null=True, verbose_name='名字')),
                ...
                ('career', models.CharField(choices=[('student', '学生'), ('others', '其他')], default='student', max_length=20)),
